...
tqdm.pandas(desc="Cleaning Noise From Data...")
...
tqdm.pandas(desc="Removing Stop Words From Data...")
...
classifying.classify(vectors_a[:], labels_a[:], text_vector, "A", "LR")

print("\nBuilding Model Subtask B...")
classifying.classify(vectors_b[:], labels_b[:], text_vector, "B", "LR")

print("\nBuilding Model Subtask C...")
classifying.classify(vectors_c[:], labels_c[:], text_vector, "C", "LR")
